...
![prototype_constructor](../img/prototype_constructor.png)
...
- 在不同情况下的实现与原型的关系（为了简单起见，图中省略了与Person 构造函数的关系）。
  ...
  ![prototype_object](../img/prototype_object.png)
...
- - 调用构造函数时会为实例添加一个指向最初原型的[[Prototype]]指针，而把**原型修改为另外一个对象**就等于**切断了构造函数与最初原型之间的联系**。
  ...
  - - 发生了错误，因为friend 指向的原型中不包含以该名字命名的属性。
      ...
      ![prototype_cut](../img/prototype_cut.png)
...
![prototype_chain_all](../img/prototype_chain_all.png)
...
![combination_inheritance](../img/combination_inheritance.png)
