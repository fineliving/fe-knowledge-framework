...
- 特殊的字符字面量——转义序列
  ...
  - 用于表示非打印字符，或者具有其他用途的字符。
    ...
    ![non-printable](../img/non-printable.png)
...
<img src="../img/bitwise-positive.png" alt="bitwise-positive" style="zoom:75%;" />

计算-18的二进制补码：
<img src="../img/bitwise-negative.png" alt="bitwise-negative" style="zoom:75%;" />
...
| --------------- | ---- | ------------------------------------------------------------ |
| 按位非（NOT）   | ~    | 返回**数值的反码**                                           |
| 按位与（AND）   | \&   | ![bitwise-and](../img/bitwise-and.png) |
| 按位或（OR）    | \|   | ![bitwise-or](../img/bitwise-or.png) |
| 按位异或（XOR） | ^    | ![bitwise-xor](../img/bitwise-xor.png) |
| 左移            | <<   | 将数值的所有位向左移动指定的位数                             |
...
<img src="../img/bitwise-or-demo.png" alt="bitwise-or-demo"  />
...
25 与3 按位异或的结果是26：
![bitwise-xor-demo](../img/bitwise-xor-demo.png)
...
将数值2 向左移动5 位（得到64）：
![bitwise-left](../img/bitwise-left.png)
...
将数值64 向右移动5 位（得到2）：
![bitwise-right](../img/bitwise-right.png)
...
| ------ | ---- | ------------------------------------------------------------ |
| 逻辑非 | ！   | 转换为一个布尔值，再求反                                     |
| 逻辑与 | &&   | ![boolean-and](../img/boolean-and.png) |
| 逻辑或 | \|\| | ![bitwise-or](../img/bitwise-or.png) |
...
- 下表列出了一些特殊情况及比较结果：
  ...
  ![equality_operator](../img/equality_operator.png)
